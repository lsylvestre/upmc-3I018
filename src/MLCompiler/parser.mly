...
statement:
  | IDENTIFIER LBRACKET expr RBRACKET EQ expr { ArrayAssign ($1, $3, $6, current_pos ()) }
  ...
  | LET IDENTIFIER EQ expr { Let($2, $4, current_pos ()) }
...
| expr LBRACKET expr RBRACKET { ArrayRef($1, $3, current_pos ()) } 
| expr LPAREN arguments RPAREN { Funcall($1, $3, current_pos ()) }
| IDENTIFIER            { EVar ($1, current_pos ()) }
| LPAREN expr RPAREN    { $2 }
| expr PLUS expr        { BinOp(Add, $1, $3, current_pos ()) }
| expr MINUS expr        { BinOp(Sub, $1, $3, current_pos ()) }
| expr TIMES expr        { BinOp(Mult, $1, $3, current_pos ()) }
| expr DIV expr        { BinOp(Div, $1, $3, current_pos ()) }
| expr EQEQ expr       { BinOp(BEq, $1, $3, current_pos ()) }
| expr INF expr        { BinOp(BInf, $1, $3, current_pos ()) }
| expr INFEQ expr        { BinOp(BInfeq, $1, $3, current_pos ()) }
| expr SUP expr        { BinOp(BSup, $1, $3, current_pos ()) } 
| expr SUPEQ expr        { BinOp(BSupeq, $1, $3, current_pos ()) }
| LBRACKET arguments RBRACKET { ArrayLiteral($2, current_pos ()) }
       ;
